...
public class TestCases
{
   ...
   {
        assertEquals(4.0, SimpleIf.max(4.0, 4.0), DELTA);
   }
   ...
   {
        assertEquals(5050, SimpleLoop.sum(0,100));
   }
   ...
   {
      List<Integer> input =
         new LinkedList<Integer>(Arrays.asList(new Integer[] {8, 4}));
      List<Integer> expected =
         new ArrayList<Integer>(Arrays.asList(new Integer[] {64, 16}));
   ...
   {
        assertFalse(BetterLoop.contains(new int[] {7, 5, 4}, 3));
   }
   ...
   {
      List<String> expected = Arrays.asList("Workman", "Hatalsky");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();
      ...
      courseListsByStudent.put("Workman",
         Arrays.asList(
            ...
            new Course("CPE 203", 12),
            new Course("CPE 225", 4)));
      courseListsByStudent.put("Hatalsky",
         Arrays.asList(
            new Course("CPE 101", 35),
            new Course("CPE 202", 4),
            new Course("CPE 203", 123),
            new Course("CPE 225", 4)));
      courseListsByStudent.put("Zoe",
         Arrays.asList(
            new Course("CPE 123", 4),
