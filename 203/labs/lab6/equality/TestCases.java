...
public class TestCases
{
   ...
   public void testExercise1()
   {
      ...
      final CourseSection t = new CourseSection(null, "203", 35,
         LocalTime.of(9, 40), LocalTime.of(11, 0));
      final CourseSection f = new CourseSection(null, "203", 35,
         LocalTime.of(9, 40), LocalTime.of(11, 0));

      assertTrue(t.equals(f));
      assertTrue(f.equals(t));
      final CourseSection a = new CourseSection(null, null, 35,
         LocalTime.of(9, 40), LocalTime.of(11, 0));
      final CourseSection b = new CourseSection(null, null, 35,
         LocalTime.of(9, 40), LocalTime.of(11, 0));
