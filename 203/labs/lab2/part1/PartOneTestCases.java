...
public class PartOneTestCases
{
      ...
      throws NoSuchMethodException
   {
    ...
    public void testPerimCir() {
        ...
        double d = Util.perimeter(new Circle(center, 0.5));
    ...
    public void testPerimRect() {
        ...
        double d = Util.perimeter(new Rectangle(topL, botR));
    ...
    public void testBigger() {
        ...
        points.add(new Point(3,0));
        points.add(new Point(0,4));
        double d = Bigger.whichIsBigger(new Circle(center, .5), new Rectangle(topL, botR), new Polygon(points));
        assertEquals(26.0, d, DELTA);
   }
    @Test
    ...
    public void testBigger3() {
        ...
        points.add(new Point(3,0));
        points.add(new Point(0,4));
        double d = Bigger.whichIsBigger(new Circle(center, 100), new Rectangle(topL, botR), new Polygon(points));
    ...
    public void testBigger4() {
        ...
        points.add(new Point(3,0));
        points.add(new Point(0,4));
        double d = Bigger.whichIsBigger(new Circle(center, 10), new Rectangle(topL, botR), new Polygon(points));
